...
public class Query {
	...
	public void setQueryPrivate(boolean value) {
		this.queryPrivate = value;
	}

	public List<String> getBoundaryCountry() {
		return boundaryCountry;
	}

	public void setBoundaryCountry(List<String> value) {
		this.boundaryCountry = value;
	}
	...
	public void setQuerySize(long value) {
	...
	public void setParsedText(ParsedText value) {
